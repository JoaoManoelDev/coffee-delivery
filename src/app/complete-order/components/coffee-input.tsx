...
interface CoffeeInputProps {
  quantity: number
  coffeeId: string
  onIncrease: (coffeeId: string) => void
  onDecrease: (coffeeId: string) => void
}

export function CoffeeInput({ onDecrease, onIncrease, quantity, coffeeId }: CoffeeInputProps) {
  return (
